...
設計原則:
- 只取「會影響美股」的高權重美國總經事件
  (FOMC 利率決議 / 會議紀要、非農 NFP、CPI、PCE、PPI、ISM、零售銷售、GDP、ADP)。
...
# 注意順序:「ADP非農就業」要排在「非農就業人數」之前才不會誤判
# (ADP 那條是「ADP非農就業人口」,NFP 那條是「非農就業人數」,字串本就不同,
#  但保險起見仍把較特定的放前面)。
MACRO_KEYWORDS: list[tuple[str, str]] = [
    ("聯準會利率決策", "美國 FOMC 利率決議"),
    ("聯準會會議紀要", "美國 FOMC 會議紀要"),
    ("ADP非農就業", "美國 ADP 就業"),
    ("非農就業人數", "美國 非農就業 NFP"),
    ("消費者物價指數", "美國 CPI 消費者物價"),
    ("個人消費支出物價指數", "美國 PCE 物價指數"),
    ("生產者物價指數", "美國 PPI 生產者物價"),
    ("ISM製造業", "美國 ISM 製造業 PMI"),
    ("ISM非製造業", "美國 ISM 服務業 PMI"),
    ("ISM服務業", "美國 ISM 服務業 PMI"),
    ("零售銷售", "美國 零售銷售"),
    ("實質國內生產毛額", "美國 GDP"),
]
